          ...
          >
            <div className="flex lg:flex-1">
              <a href="/" className="-m-1.5 p-1.5">
                <span className="sr-only">Lisa Works. Cables, tailored.</span>
                <img
                  className="h-8 w-auto"
                  src="/LisaWorksLogoFilledIn.png"
                  alt=""
                />
              </a>
            </div>
          ...
          >
            ...
            <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
              <div className="flex items-center justify-between">
                <a href="#" className="-m-1.5 p-1.5">
                  <span className="sr-only">Lisa Works Logo</span>
                  <img
                    className="h-8 w-auto"
                    src="/LisaWorksLogoFilledIn.png"
                    alt=""
          ...
          {/* <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <p className="mt-6 text-xl leading-8 text-gray-900">
                Dedicated to creating nothing less than the best.
              </p>
